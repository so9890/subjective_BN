...
\begin{frame}{This Paper: Exercises}
	...
	%\end{itemize}
	\begin{enumerate}
		\item[4.] Can a restriction on working hours replicate the optimal allocation from point 3?
		\item[5.] What are the effects of a restriction of working hours on inequality? 
		\item[6.] calculate optimal policy in full model from an economic policy perspective \ar Is a working hour restriction still part of the optimal policy? 
	\end{enumerate}
\end{frame}
...
\begin{itemize}
	...
	\item \cite{Eriksson2018PhasingChange}(Economic Modelling) \ar continued government intervention and long-run growth drag 
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{\cite{Brock2005ChapterEmpirics} (Handbook of Economic Growth)}\ar argue for non-existence of pollution-free technology. It follows that, when environmental boundaries have to be respected, there is a limit to growth
\end{itemize}\alert{
...
\textbf{- Distortionary taxes and endogenous growth models}
\begin{itemize}
...
\item lower demand/ labour supply \ar reduces profits\ar slows down innovations and recomposition
\item with heterogeneous skills: if high-skilled labour supply more elastic to after-tax wage \ar reduce their labour supply more \ar production costs in clean sector rise \ar demand shifts to dirty sector \ar relation of market-size and price effect determine effect on direction of innovations
	\end{enumerate}
	%\begin{itemize}
	...
	%\end{itemize}
	\textbf{b) Inequality/ social acceptance}
	\begin{itemize}
\item ?
	\end{itemize}
\end{frame}
...
\begin{enumerate}[a)]
	...
	\begin{align*}
	&\underset{\tau_l, \tau_n, \tau_i}{\max} \lambda U_h+(1-\lambda)U_l\\
	s.t.\ & feasibility\\
	& behaviour\  of\  agents 
	\end{align*}
...
\begin{itemize}
\item Is a working time reduction optimal when directed technical change is accounted for?
