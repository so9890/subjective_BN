...
\vspace{3mm}
	\item Carbon taxes direct demand towards low-emission alternatives \underline{and} direct research across sectors
	\vspace{3mm}
	\item A labor income tax affects the level of production \ar a combined policy may allow to target research more
	\vspace{3mm}
