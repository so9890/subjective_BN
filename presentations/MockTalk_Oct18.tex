...
\vspace{3mm}
	\item carbon taxes (i) direct demand towards emission-low alternatives\\ \hspace{13mm} \underline{and} (ii) research across sectors
	\vspace{3mm}
...
\end{itemize}
	...
	\vspace{2mm}
	\begin{itemize}
		\item \normalsize{once the carbon tax targets research activity, the wage rate no longer fully reflects the social costs of labor}
		\vspace{2mm}
		\item[\ar]  \normalsize{households do not correctly internalize the social costs of labor}
	\end{itemize}
...
\begin{frame}{First-best allocation}
	\centering
\begin{figure}[h!!]
	\centering
...
\vspace{5mm}
\begin{block}{}
	\ \ \ \ First-best: more fossil research and high green-to-fossil energy ratio. \\ 
	\ \ \ \ Optimal policy: trade-off between fossil research and demand 
\end{block}	
\end{frame}

\begin{frame}{Use of labor income tax´}
	\centering
	\begin{figure}[h!!]
		\centering
		\begin{subfigure}{0.32\textwidth}		
