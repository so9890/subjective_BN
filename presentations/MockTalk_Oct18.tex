...
\begin{frame}{Model Overview}
	\begin{figure}[h]
		...
		\node[circll] (A) at (-6,4) {\textbf{Production}};
		\node[circll] (B) at (6,4) {\textbf{\hyperlink{backhh}{\alert{Household}}}};
...
\vspace{4mm}
\\
s.t.\ C_t=(\alert{\pmb{1-\tau_{\iota t}}})w_{ht}H_{t}+w_{st}S_t+T_t%+Gov_t
%\\
...
\begin{minipage}[t!]{0.37\textwidth}
	\vspace{8mm}
	\begin{itemize}
		\item[] $w_{ht}, w_{st}$: wages  \vspace{-2mm}
...
\begin{frame}{Model Overview}
	\begin{figure}[h]
		...
		\node[circll] (A) at (-6,4) {\textbf{\hyperlink{prodmod}{\alert{Production}}}};
...
\begin{frame}{}
	\begin{figure}[h]
		\vspace{-4mm}
		\centering
		\begin{tikzpicture}[auto,scale=.9, transform shape]
		...
		\node[draw=none] (A4) at (-4,0.2) {Workers};
		%	\node[dialog] (F) at (3.5,-3.0) {Moralischer \\ Modus};
...
\begin{minipage}[t!]{1\textwidth}
	...
	\underset{\{x_{ijt}\}_{i=0}^1, L_{jt}}{\max}\ & \pi_{jt}=p_{jt}J_t-w_{ljt}L_{jt}-\int_{0}^{1}p_{xijt}x_{ijt}di \hspace{3mm} \pmb{\alert{for\  J=F}}\\ 
...
\begin{figure}[h!!]
	...
	\begin{subfigure}[]{0.4\textwidth}
		...
		%	\captionsetup{width=.45\linewidth}
		\includegraphics[width=1\textwidth]{../codding_model/own_basedOnFried/optimalPol_010922_revision/figures/all_13Sept22_Tplus30/sffsg_slides_CompEffOPT_T_NoTaus_regime4_opteff_knspil0_spillover0_noskill0_sep0_xgrowth0_countec0_PV1_etaa0.79_lgd1_lff1.png}
	\end{subfigure}	
\begin{minipage}[]{0.1\textwidth}
\ 
\end{minipage}
\begin{subfigure}{0.4\textwidth}		
	...
	%	\captionsetup{width=.45\linewidth}
	\includegraphics[width=1\textwidth]{../codding_model/own_basedOnFried/optimalPol_010922_revision/figures/all_13Sept22_Tplus30/GFF_slides_CompEffOPT_T_NoTaus_regime4_opteff_knspil0_spillover0_noskill0_sep0_xgrowth0_countec0_PV1_etaa0.79_lgd0_lff1.png}
\end{subfigure}
\end{figure}
\pause
\vspace{3mm}
...
\begin{frame}{Deviation from carbon-tax-only policy, in percent}
	\pause
	\centering
	\begin{figure}
	\begin{subfigure}{0.4\textwidth}
	\caption{\normalsize{Carbon tax}}
	%	\captionsetup{width=.45\linewidth}
...
\begin{frame}{Decomposition}
	...
	\begin{block}{}
		\begin{itemize}
	\item a smaller carbon tax reduces energy ratio; it leaves hours unchanged
    \item[ ]\
		\end{itemize}
	\end{block}	
\end{frame}
...
\begin{frame}{Conclusion}
	...
	\vspace{3mm}
	\item under the net-zero emission limit: carbon is taxed heavily to reduce fossil demand and research. A subsidy on labor stabilizes output.
	\vspace{3mm}
	\item before the net-zero emission limit: it is optimal to reduce fossil research less. The carbon tax is lower, and a labor tax reduces emissions. 
\end{itemize}
\end{frame}
