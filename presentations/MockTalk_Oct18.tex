...
\end{align*}
	\begin{itemize}
		...
		\item decreasing returns to research
	\end{itemize}
	\small
	\vspace{7mm}
	\hspace{-4mm}
...
\begin{frame}{Production: returns to research}
	...
	\begin{itemize}
		...
		\item scientists more productive in advanced sectors \ar path dependency
		\item knowledge from other sectors increases productivity of scientists
		\item \alert{decreasing returns to research}
	\end{itemize}
	\small
	\vspace{7mm}
	\hspace{-4mm}
...
\begin{itemize}
	...
	\end{itemize}
\vspace{2mm}
	\item<+-> political goal: $-38\%$ by 2030 relative to 2019\\ \hspace{4mm} \small{\ar 5 times equal-per-capita share of remaining carbon budget}
\end{itemize}
\end{frame}
...
\begin{frame}{Conclusion}
	...
	\begin{itemize}
		\item[-] excessive carbon tax to reduce fossil demand and research
