...
\begin{itemize}[<+-| alert@+>]
	...
	\vspace{3mm}
	\item but: economic models on optimal environmental policy abstract from reductive policy tools (e.g. distortionary fiscal policies)% inelastic labour supply, no income tax
	\vspace{3mm}
...
\begin{enumerate}
	\item<+-> the \alert{optimal income tax is progressive}  to reduce inefficiently high hours worked
		\vspace{5mm}
	\item<+-> income taxes contribute to social welfare by 0.11\%  \small{(with one skill only by 0.85\%)}  %but are nnot necessary to meet the emission limit %over the 60 years from 2020 to 2080
	...
	\item<+->  \alert{corrective tax  suffices to meet emission limit}
\end{enumerate}
\end{frame}
%\begin{frame}{Roadmap}
%	\tableofcontents
...
\begin{frame}{Model}
	...
	\begin{itemize}
		\item<+-> a representative family consisting of
		 a unit mass of workers: a share $z_h$ of high-skilled workers; a share of $1-z_h$ is low skilled
		 \vspace{2mm}
		\item<+-> competitive final and intermediate good producers, monopolistic competitive machine producers
		\vspace{2mm}
		\item<+-> endogenous research
				 and elastic supply of scientists 
				 \vspace{2mm}
		\item<+-> government seeks to maximise social welfare but is constrained by an emission limit
	\end{itemize} 
\end{frame}
...
&
(2)\ \ \alert{ \omega F_t-\delta =\Omega_t }%\  \forall\ \  t\in[0,T]
\\
...
\begin{frame}{Conclusion}
	...
	hours worked
	\vspace{3mm}
	\item<+-> welfare gains of income tax amount to 0.11\% (0.85\% with one skill) over the horizon from 2020 to 2080
   \vspace{3mm}
	\item<+->  qualitative finding robust to
	\begin{itemize}
...
\begin{frame}{Efficient and optimal allocation iii}
	...
	\begin{minipage}[]{0.3\textwidth}
		...
		%	\captionsetup{width=.45\linewidth}
		\includegraphics[width=1\textwidth]{../codding_model/own_basedOnFried/optimalPol_elastS_DisuSci/figures/all_1705/Ag_CompEffOPT_T_NoTaus_spillover0_noskill0_sep1_BN0_ineq0_red0_xgrowth0_zero0_countec0_etaa0.79_lgd1.png}
	\end{minipage}
	\begin{minipage}[]{0.3\textwidth}
		\centering{\footnotesize{Fossil productivity}}
		%	\captionsetup{width=.45\linewidth}
		\includegraphics[width=1\textwidth]{../codding_model/own_basedOnFried/optimalPol_elastS_DisuSci/figures/all_1705/Af_CompEffOPT_T_NoTaus_spillover0_noskill0_sep1_BN0_ineq0_red0_xgrowth0_zero0_countec0_etaa0.79_lgd0.png}
	\end{minipage}
	\begin{minipage}[]{0.3\textwidth}
		\centering{\footnotesize{Non-energy productivity}}
		%	\captionsetup{width=.45\linewidth}
		\includegraphics[width=1\textwidth]{../codding_model/own_basedOnFried/optimalPol_elastS_DisuSci/figures/all_1705/An_CompEffOPT_T_NoTaus_spillover0_noskill0_sep1_BN0_ineq0_red0_xgrowth0_zero0_countec0_etaa0.79_lgd0.png}
	\end{minipage}
	\begin{minipage}[]{0.3\textwidth}
		\centering{\footnotesize{Consumption to GDP}}
		%	\captionsetup{width=.45\linewidth}
		\includegraphics[width=1\textwidth]{../codding_model/own_basedOnFried/optimalPol_elastS_DisuSci/figures/all_1705/CY_CompEffOPT_T_NoTaus_spillover0_noskill0_sep1_BN0_ineq0_red0_xgrowth0_zero0_countec0_etaa0.79_lgd0.png}
	\end{minipage}
	\begin{minipage}[]{0.3\textwidth}
