...
\vspace{3mm}
\item economic models focus on emissions from fossil energy utilisation and usually assume (1) percentage reductions in fossil energy as targets or (2) allow for a trade-off between pollution and consumption
\vspace{3mm}
\item With an exogenous and absolute emission target the capacity to innovate green and the elasticities of substitution between green and fossil energy are key to whether (a) consumption can continue to grow, and (b) corrective emission taxes are sufficient to meet targets 
...
\vspace{3mm}
\item What is the optimal policy to meet emission targets?
\end{itemize}
\end{frame}
