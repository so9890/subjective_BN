...
\vspace{7mm}
	...
	\begin{minipage}[]{0.3\textwidth}
		...
		%	\captionsetup{width=.45\linewidth}
		\includegraphics[width=1\textwidth]{../codding_model/own_basedOnFried/optimalPol_elastS_DisuSci/figures/all_1705/hh_CompEffOPT_T_NoTaus_spillover0_noskill0_sep1_BN0_ineq0_red0_xgrowth0_zero0_countec0_etaa0.79_lgd1_lff1.png}
	\end{minipage}
\begin{minipage}[]{0.3\textwidth}
...
%	\item[]<+-> \ar welfare gains from  leisure 
	\vspace{2mm}
	\item<+-> the planner accepts an inefficient skill ratio and lower consumption
...
\begin{frame}{Conclusion}
	...
	hours worked
	\vspace{3mm}
	\item<+-> welfare gains of income tax amount to 0.11\%  over the horizon from 2020 to 2080 \small{(0.85\% with one skill)}
   \vspace{3mm}
