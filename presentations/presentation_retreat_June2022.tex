...
\begin{frame}{This paper}
	\begin{itemize}
		...
		\item<+->  \alert{representative} household % \alert{elastically} supplies labour 
		\vspace{2mm}
		\begin{itemize}
...
\vspace{4mm}
\\
s.t.\ C_t=z_h \alert{\pmb{\lambda_t}} (w_{ht}h_{ht})^{\alert{\pmb{1-\tau_{lt}}}}+(1-z_h) \pmb{\alert{\lambda_t}} (w_{lt}h_{lt})^{\alert{\pmb{1-\tau_{lt}}}}%+Gov_t
\\
