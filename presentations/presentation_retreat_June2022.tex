...
%		%	\captionsetup{width=.45\linewidth}
%		\includegraphics[width=1\textwidth]{../codding_new/policies_solution/solutions_paper/fullmodel_pen1_targetext_2_T_withps0_lgd0_notauun0_pslow0_PSID1_matchGDP0_phii12_xaxisms_circlesevol.png}
%	\end{minipage}
...
\begin{frame}{Main Result 2:  With satiation point}
			\centering
\begin{minipage}[]{0.32\textwidth}
	\centering{\footnotesize{Same satiation point\\ \ }}
	%	\captionsetup{width=.45\linewidth}
...
\end{minipage}
\begin{minipage}[]{0.32\textwidth}
	\centering{\footnotesize{High-skilled reduce satiation point\\ \ }}
	%	\captionsetup{width=.45\linewidth}
...
%		\centering{\footnotesize{High-skilled reduce satiation point\\ \ }}
%		%	\captionsetup{width=.45\linewidth}
%		\includegraphics[width=1\textwidth]{../codding_model/own_basedOnFried/optimalPol_elastS_DisuSci/figures/all_1705/taul_TargetCompOPT_T_NoTaus_spillover0_sep1_BN1_ineq0_red1_etaa0.79_lgd1}
%	\end{minipage}
\end{frame}
\appendix
\begin{frame}{Working hypotheses}	
