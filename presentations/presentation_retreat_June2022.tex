...
\begin{enumerate}
	...
	\vspace{5mm}
	\item<+-> income taxes contribute to social welfare by 0.11\%  \small{(with one skill type by 0.85\%)}  %but are nnot necessary to meet the emission limit %over the 60 years from 2020 to 2080
...
%& h_h^*=\frac{\overbrace{\left(\frac{1-\tau_l}{\chi}\right)^{\frac{1}{1+\sigma}}}^{\text{substitution effect}}}{ \underbrace{\left(z_h+(1-z_h)\left(\frac{w_l}{w_h}\right)^{\frac{(1-\tau_l)^3}{\sigma+\tau_l}}\right)^{\frac{1}{1+\sigma}}}_{\text{income effect}}};& h_l^*=\frac{\overbrace{\left(\frac{1-\tau_l}{\chi}\right)^{\frac{1}{1+\sigma}}}^{\text{substitution effect}}}{ \underbrace{\left(z_h\left(\frac{w_h}{w_l}\right)^{\frac{(1-\tau_l)^3}{\sigma+\tau_l}}+(1-z_h)\right)^{\frac{1}{1+\sigma}}}_{\text{income effect}}}
		\end{align*}
