...
\begin{frame}{Contribution}
	\begin{itemize}
		\item Optimal policy relative to Fried and a dynamic emission limit
	\item \cite{Acemoglu2012TheChange} I add more realistic aspects of productivity creation \ar (i) increasing policy intervention, (ii) potentially advantageous to maintain some fossil research
	\item to the environmental policy literature I add the focus on labor income taxes as an environmental policy tool: Can they help meet first-best?
	\end{itemize}
\end{frame}
...
%\begin{frame}{Decomposition: effect adjustment carbon tax}
%	\hypertarget{decomp}{}
%	\centering
%	
%	\begin{figure}[h!!]
