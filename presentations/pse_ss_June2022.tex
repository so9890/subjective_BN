...
\begin{frame}{Results in a Nutshell}
	\pause
\begin{enumerate}
...
\begin{frame}{Model}
	...
	\begin{itemize} 
		...
		\end{itemize}
		 	\item<+-> \textbf{government} \begin{itemize}
		 	\item[-]<+-> maximises social welfare but constrained by an \alert{emission limit constraints}
		 	\vspace{1mm}
		 	\item[-]<+-> can use \alert{fossil} and \alert{distortionary income taxes}
		 \end{itemize}
...
\begin{frame}{Benefits of progressive income taxes}
	...
	\begin{minipage}[]{0.3\textwidth}
		...
		%	\captionsetup{width=.45\linewidth}
		\includegraphics[width=1\textwidth]{../codding_model/own_basedOnFried/optimalPol_elastS_DisuSci/figures/all_1705/tauf_CompEffOPT_T_NoTaus_noopt_spillover0_noskill0_sep1_BN0_ineq0_red0_xgrowth0_zero0_countec0_etaa0.79_lgd0.png}
	\end{minipage}
...
\begin{frame}{Benefits of progressive income taxes}
	...
	\begin{minipage}[]{0.3\textwidth}
		\centering{\footnotesize{Social costs of emissions and corrective tax}}
		%	\captionsetup{width=.45\linewidth}
		\includegraphics[width=1\textwidth]{../codding_model/own_basedOnFried/optimalPol_elastS_DisuSci/figures/all_1705/tauf_CompEffOPT_T_NoTaus_spillover0_noskill0_sep1_BN0_ineq0_red0_xgrowth0_zero0_countec0_etaa0.79_lgd0.png}
	\end{minipage}
	\pause
	\vspace{4mm}
	\begin{block}{}
