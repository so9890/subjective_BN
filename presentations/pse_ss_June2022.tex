...
\begin{frame}{Paper in a nutshell}
	...
	\vspace{-1mm}
		...
		\vspace{3mm}
		%	\item<+-> profitability of research in each sector determines sector growth
		\item[-]<+->  \alert{representative} household  {elastically} supplies labour  
	\end{itemize}
	\pause
	\underline{Results}
\begin{itemize}
...
\begin{frame}{Benefits of progressive income taxes}
	...
	\begin{minipage}[]{0.3\textwidth}
		...
		%	\captionsetup{width=.45\linewidth}
		\includegraphics[width=1\textwidth]{../codding_model/own_basedOnFried/optimalPol_elastS_DisuSci/figures/all_1705/tauf_CompEffOPT_T_NoTaus_spillover0_noskill0_sep1_BN0_ineq0_red0_xgrowth0_zero0_countec0_etaa0.79_lgd0_lff0.png}
	\end{minipage}
	\begin{minipage}[]{0.3\textwidth}
		\centering{\footnotesize{High skill hours worked\\ \  }}
		%	\captionsetup{width=.45\linewidth}
