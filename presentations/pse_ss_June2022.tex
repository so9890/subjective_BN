...
\begin{itemize}
	...
	\vspace{0mm}
		...
		\vspace{2mm}
		%	\item<+-> profitability of research in each sector determines sector growth
		\item[-]<+->  \alert{representative} household  supplies labour  {elastically}
	\end{itemize}
...
\vspace{9mm}
\hfill
\hyperlink{backhh}{\tiny{$\rightarrow$ model}}
\end{frame}
...
\begin{frame}{Benefits of progressive income taxes: Social planner allocation}
	...
	\begin{minipage}[]{0.3\textwidth}
		\centering{\footnotesize{Social costs of emissions }}
		%	\captionsetup{width=.45\linewidth}
...
\begin{frame}{Benefits of progressive income taxes}
	...
	\begin{minipage}[]{0.3\textwidth}
		\centering{\footnotesize{Social costs of emissions and corrective tax}}
		%	\captionsetup{width=.45\linewidth}
