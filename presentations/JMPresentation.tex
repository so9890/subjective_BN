...
%\institute{University of Bonn} 
\date{\small{Mock Presentation\\ December 19, 2022 }} 
%\subject{} 
\begin{document}
...
\begin{frame}{Motivation}
	...
	\begin{itemize}
		...
		%	\vspace{3mm}
		\item Meeting climate targets requires reducing fossil energy use
		\vspace{3mm}
		\item Non-green innovation fosters green innovation \citep{Barbieri2021GreenPolicy} %\\ \ar mitigate reduction in non-green innovation
		\vspace{3mm}
		\item[\ar] Does this constitute Challenge: reduce fossil energy use $\leftrightarrow$ preserve research on non-green technologies
		\vspace{-2mm}
		\item Carbon taxes lower fossil energy use \underline{and} discourage R\&D investment in non-green sectors
		\vspace{3mm}
		\item Labor income taxes: reduce level of production overall but leave allocation of researchers unaffected
		\vspace{3mm}
		\item {What is the optimal mix of carbon and labor income taxes to lower emissions?}
	\end{itemize}
\end{frame}
...
\begin{frame}{Preview of results}
	...
	\begin{itemize}[<+-| alert@+>]
		...
		\end{itemize}
		\vspace{3mm}
		\item A significant gap between the social planner and optimal allocation calls for additional policy measures
...
\begin{itemize}[<+->]
	...
	\vspace{2mm}
	\item \alert{Motive for income taxation emerges from directed technical change}\\  \footnotesize{\citep{Acemoglu2012TheChange}}
	%			\begin{itemize}
...
\begin{minipage}[t!]{1\textwidth}
	\begin{align*}
		...
		\vspace{4mm}
		\\
		\text{s.t.}\ C_t=(\alert{\pmb{1-\tau_{\iota t}}})w_{t}H_{t}+w_{st}S_t+T_t%+Gov_t
		%\\
	...
	\begin{center}
		...
		\resizebox{5.6in}{!}{
			\begin{tabular}{l|lll}
				...
				${{\phi}}$  &0.50& \small{cross-sector knowledge spillovers}&  \\
				$({\varepsilon_y, \varepsilon_e})$&(0.05, 1.50)&price elasticity of substitution&\\	
				%	($\alpha_F$, $\alpha_G$, $\alpha_N$) &(0.72, 0.91, 0.36)&\\
				({${A_{F0}^{1-alpha_f}}$, ${A_{G0}^{1-alpha_g}}$, ${A_{N0}^{1-alpha_n}}$})&(8.21, 1.27, 2.80)&TFP &energy and fossil shares \citep{EIAEnergy} \\
...
\begin{figure}[h!!]
	...
	\begin{subfigure}{0.4\textwidth}		
		\caption{Tax per ton of carbon,  US\$, $\tau_{Ft}$}
		%	\captionsetup{width=.45\linewidth}
		\includegraphics[width=1\textwidth]{../codding_model/own_basedOnFried/optimalPol_010922_revision/figures/all_13Sept22/Ems_Sens_Tauf_spillover0_knspil3_xgr0_nsk0_sep0_extern0_PV1_etaa0.79_lgd0.png}
	\end{subfigure}	
	\begin{minipage}[]{0.1\textwidth}
		\ 
	\end{minipage}
	\begin{subfigure}{0.4\textwidth}		
		\caption{Marginal tax rate in \%, $\tau_{\iota t}$}
		%	\captionsetup{width=.45\linewidth}
		\includegraphics[width=1\textwidth]{../codding_model/own_basedOnFried/optimalPol_010922_revision/figures/all_13Sept22/Ems_Sens_dTaulAv_spillover0_knspil3_xgr0_nsk0_sep0_extern0_PV1_etaa0.79_lgd1.png}
	\end{subfigure}
...
\begin{figure}
	\begin{subfigure}{0.42\textwidth}
		\caption{{\% deviation carbon tax}}
		%	\captionsetup{width=.45\linewidth}
		\includegraphics[width=1\textwidth]{../codding_model/own_basedOnFried/optimalPol_010922_revision/figures/all_13Sept22/EmsDecomp_CTO_Sens_Tauf_spillover0_knspil3_xgr0_nsk0_sep0_extern0_PV1_etaa0.79_lgd1.png}
	\end{subfigure}
	\begin{minipage}[]{0.1\textwidth}
		\
	\end{minipage}
	\begin{subfigure}{0.4\textwidth}
		\caption{{\% deviation fossil-to-green scientists }}
		%	\captionsetup{width=.45\linewidth}
		\includegraphics[width=1\textwidth]{../codding_model/own_basedOnFried/optimalPol_010922_revision/figures/all_13Sept22/EmsDecomp_CTO_Sens_sffsg_spillover0_knspil3_xgr0_nsk0_sep0_extern0_PV1_etaa0.79_lgd0.png}
	\end{subfigure}
\end{figure}
\vspace{3mm}
\begin{block}{}
...
\begin{frame}{Decomposition}
	...
	\begin{figure}[h!!]
		\centering
		\begin{subfigure}{0.4\textwidth}		
			\caption{{\% deviation scientists }}
			%	\captionsetup{width=.45\linewidth}
			\includegraphics[width=1\textwidth]{../codding_model/own_basedOnFried/optimalPol_010922_revision/figures/all_13Sept22_Tplus30/CountTAUF_Both_Opt_target_S_nsk0_xgr0_knspil0_regime4_spillover0_sep0_extern0_PV1_etaa0.79_lgd1.png}
		\end{subfigure}
		\begin{minipage}[]{0.1\textwidth}
			\
		\end{minipage}
		\begin{subfigure}{0.4\textwidth}		
			\caption{{\% deviation aggregate Tech}}
			%	\captionsetup{width=.45\linewidth}
			\includegraphics[width=1\textwidth]{../codding_model/own_basedOnFried/optimalPol_010922_revision/figures/all_13Sept22_Tplus30/CountTAUF_Both_Opt_target_gAagg_nsk0_xgr0_knspil0_regime4_spillover0_sep0_extern0_PV1_etaa0.79_lgd0.png}
		\end{subfigure}
	\end{figure}
...
\begin{frame}{Decomposition: New Calibration}
	\hypertarget{decomp}{}
	\centering
	\begin{figure}[h!!]
		\centering
		\begin{subfigure}{0.3\textwidth}		
			\caption{{\% deviation scientists }}
			%	\captionsetup{width=.45\linewidth}
			\includegraphics[width=1\textwidth]{../codding_model/own_basedOnFried/optimalPol_010922_revision/figures/all_13Sept22/CountTAUF_Both_Opt_NewCalib_target_S_nsk0_xgr0_knspil0_regime4_spillover0_sep0_extern0_PV1_etaa0.79_lgd1.png}
		\end{subfigure}
		\begin{subfigure}{0.3\textwidth}		
			\caption{{\% deviation GFF}}
			%	\captionsetup{width=.45\linewidth}
			\includegraphics[width=1\textwidth]{../codding_model/own_basedOnFried/optimalPol_010922_revision/figures/all_13Sept22/CountTAUF_Both_Opt_NewCalib_target_GFF_nsk0_xgr0_knspil0_regime4_spillover0_sep0_extern0_PV1_etaa0.79_lgd0.png}
		\end{subfigure}
	\begin{subfigure}{0.3\textwidth}		
	\caption{{\% deviation hours worked}}
	%	\captionsetup{width=.45\linewidth}
	\includegraphics[width=1\textwidth]{../codding_model/own_basedOnFried/optimalPol_010922_revision/figures/all_13Sept22/CountTAUF_Both_Opt_NewCalib_target_Hagg_nsk0_xgr0_knspil0_regime4_spillover0_sep0_extern0_PV1_etaa0.79_lgd0.png}
\end{subfigure}
	\end{figure}
...
\begin{block}{}
	\begin{itemize}
		...
		\item [] %<+-> Government dilemma: more fossil research but less fossil energy use
	\end{itemize}
\end{block}	
