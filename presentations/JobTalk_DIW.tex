...
\begin{frame}{This paper}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\vspace{1mm}
			\item[-]<+-> \alert{cross-sectoral knowledge spillovers}: knowledge accumulated in a sector stimulates innovation in other sectors %\\ \footnotesize{(cross-sectoral knowledge spillovers)}
		\end{itemize}
		\vspace{2mm}
