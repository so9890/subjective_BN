...
\begin{frame}{Motivation}
	\begin{itemize}[<+-| alert@+>]
		\setbeamercolor{alerted text}{} %change the font color
		\setbeamerfont{alerted text}{}
		\item How to best meet climate goals? % Frage
		\vspace{3mm}
		\item Problem:
			\begin{itemize}
				...
				\begin{enumerate}
					...
					\item[-] risk of duplicating ideas if all research happens in one sector
...
\begin{itemize}[<+->]
			...
			% I argue that we should study optimal env. policies allowing for level adjustments of production! I provide am example scenario where adjusting the level becomes part of the optimal policy
				\vspace{2mm}
				\item \alert{This paper}: targeting the level of production is optimal due to  directed technical change % and (ii) lack of research subsidies
