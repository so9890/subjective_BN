...
%		%	\captionsetup{width=.45\linewidth}
%		\includegraphics[width=1\textwidth]{../codding_model/own_basedOnFried/optimalPol_010922_revision/figures/all_13Sept22/NewCalib_polTaulFixedPer_T_S_Sun2_emnet1_spillover0_knspil3_xgr0_nsk0_sep0_extern0_PV1_etaa0.79.png}
%	\end{subfigure}
%	\begin{minipage}[]{0.1\textwidth}
%		\
%	\end{minipage}
...
%\begin{frame}{Comparison to carbon tax only policy}
%	\begin{figure}[h!!]
%		\centering
%		\begin{subfigure}{0.4\textwidth}		
%			\caption{{Levels  Tauf}}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%% New calibration scientists taxed, no target
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
