...
\textbf{Education}
	...
	%	\item  to be successful in life % to know what they want
		\item to enable students to take on responsibility within socitey %develop the capacity to be responsible a sense for society\textit{Verantwortung }
	\end{itemize}
...
\begin{frame}{Required competencies}
		\begin{figure}[h]
		\vspace{-12.4mm}
		\centering
...
\begin{frame}{Design of methods and learning environment} % ausgestaltung
	\begin{itemize}
...
%		\node[elli, fill=black!1] (I) at (4.8,2.8) {\ \ \ \ \ \ \ \ \ \ \textbf{Essays}\ \ \ \ \ \ \ \ \ \ };
		...
		\node[elli, fill=black!1] (I) at (9.2,1) {\ \ \ \ \  \textbf{Group work}\ \ \ \ \  };
...
\begin{frame}
	...
	\begin{tikzpicture}[auto,scale=.7, transform shape]
		...
		\node[elli, fill=black!1] (G) at (-4.6,0) {Inviting a \textbf{multitude of perspectives}};
		\begin{pgfonlayer}{bg}    % select the background layer
			\node[elli, draw=black!1, fill=black!1]  (I) at (8.5,4.5) {\ \ \ \ \  \bb{\textbf{Discussions}}\ \ \ \ \  };
			\node[elli, draw=black!1, fill=black!1] (H) at (-0.5,4.5) {\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \bb{\textbf{Flipping the classroom}}\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ };
		\end{pgfonlayer}
...
%		\pause
		...
		\begin{pgfonlayer}{bg}    % select the background layer
			\node[elli, draw=black!1, fill=black!1]  (I) at (8.5,4.5) {\ \ \ \ \  \bb{\textbf{Discussions}}\ \ \ \ \  };
			\node[elli, draw=black!1, fill=black!1] (H) at (-0.5,4.5) {\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ {\textbf{Flipping the classroom}}\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ };
		\end{pgfonlayer}
...
\section*{Intention: My teaching in the future}
