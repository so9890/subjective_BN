...
\begin{frame}{Contribution to the literature}
	\begin{itemize}[<+->]
		...
		\begin{itemize}
			\item[-]  government funding condition%; generally passive
...
\begin{frame}{Production}
	\begin{figure}[h]
		...
		\begin{tikzpicture}[auto,scale=.7, transform shape]
			...
			\node[draw=none] (D) at (-10,12) {\textcolor{black!1}{\textbf{{Fossil}}}};
			\node[draw=none] (E) at (-2,12) {\textcolor{black!1}{\textbf{{Green}}}};
			\node[draw=none] (Ems) at (-11,16) {\textcolor{black!1}{\textbf{Emissions}}};
...
\begin{frame}{\hyperlink{modma}{Innovation}}
	...
	\vspace{-1.4mm}
	\begin{enumerate}
		\item[-] within-sector knowledge spillovers \vspace{-1mm}%: sector-specific knowledge renders scientists more productive
%		\item[-] {decreasing returns to research, $\eta<1$}
