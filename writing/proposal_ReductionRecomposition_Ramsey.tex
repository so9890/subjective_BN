...
\paragraph{Alternative motivation coming from the optimal taxation literature}
The public finance literature has focused the discussion of optimal labour income taxation on the equity-efficiency trade-off. The benefits of labour taxes arise from redistribution. The optimal tax system does not feature full redistribution when labour supply is endogenous, as individuals reduce their labour supply and hence the size of the cake. Adding environmental externalities to the classical public finance framework may change the light with which efficiency costs are perceived. Instead of merely reducing welfare, direct benefits through labour reduction arise by lowering the externality. 

In the presence of corrective tax instruments, however, distortionary labour taxes are not employed as environmental policy instruments under standard preferences. Nevertheless, some (non-economist) scholars argue for the necessity to reduce current consumption levels in developed economies in light of . This can be understood by the pressing time frame to correct for climate externalities in particular, threats to other planetary boundaries (\textit{what are the distinct features due to Dasgupta?}), the irreversibility and the existence of tipping points. Furthermore, the argument is put forward that no perfectly clean technology can never be innovated.  

However, the effects of a labour supply reduction on the environment have never been studied in a general equilibrium model. Nonetheless, counteracting indirect effects could lower the effectiveness of reduction policies.  
