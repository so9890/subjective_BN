...
In this section, I spell out the tractable model. Skills are exogenous so that there is only an intensive margin, hours worked, which determines skill supply in equilibrium. In an extension, I introduce  skills as an endogenous variable the distribution of which is driven by learning ability as in \cite{Heathcote2017OptimalFramework}. \tr{I think I will change this set up to have both an intensive margin of hours worked (as it is now), and an extensive margin through skill investment as in \cite{Heathcote2017OptimalFramework}. }
...
\item how does the direction of innovation depend on tax progressivity?
