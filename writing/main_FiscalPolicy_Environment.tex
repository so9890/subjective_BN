...
\usepackage{ulem}
\title{The Environment, Inequality, and Growth\\ \small{ an optimal fiscal policy study in an endogenous growth model with inequality and emission targets}}
\date{Sonja Dobkowitz\\ Bonn Graduate School of Economics\\ %University of Bonn\\
\vspace{1mm}
%Preliminary and incomplete\\
First version: January 9, 2021\\
This version: \today }
