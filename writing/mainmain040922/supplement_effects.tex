...
Effect of taul relative to model with equal capital shares. Now, a lower labor supply is more harmful to the fossil sector relative to green, and makes non-energy goods more expensive relative to energy. 

1) When the fossil sector has a higher labor share than the green sector, emissions are reduced more by labor tax progressivity. The level effect on hours is equal. 

A higher labor share in fossil production lowers emissions also in laissez-faire. 
The wage rate increases because it labor becomes more valuable for the non-energy good. 


The ratio of green to fossil output is higher in size but reduces over time. That is, the share of the more capital intense sector decreases over time. WHy? 
More labor is now allocated to the fossil sector, and less to the green sector. 

The energy share reduces. Hence, the more capital intense sector seems to be more expensive. Capital is the scarce factor. 
But non-energy production also shrinks, because now the smaller technology level is more important?
The more capital intense a good, the more expensive it becomes. Hence, PG, pf, pe, pn. Labor allocated towards most labor intense sector: non-energy. The reallocation of input goods mitigates the rise in prices so that in sum, the non-energy goods price rises least. 
...
BECAUSE OF free labor movement! the allocation across sectors is always such that marginal products are equalized! 
}
\clearpage
\newpage
...
\clearpage
\newpage
\section{Heterogeneous skills!}


\clearpage \newpage
\section{Introducing heterogeneous skills}

\tr{Study if there is an interaction with labor share ratio}
\textbf{! Effect of taul on emissions is intensified! But green to fossil output remains unchanged! WHY? shouldnt the economy transition to sector with relatively higher input supply? That would be the fossil sector. }
