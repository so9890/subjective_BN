...
Over time, the effetc of taul is homogeneous across G, F
...
\begin{figure}[h!!]
	...
	\begin{minipage}[]{0.32\textwidth}
		\centering{\footnotesize{(g)growth non-energy}}
		%	\captionsetup{width=.45\linewidth}
		\includegraphics[width=1\textwidth]{../../codding_model/own_basedOnFried/optimalPol_010922_revision/figures/all_13Sept22/CompTaul_Equlab_LFBAU_Reg0_gAn_spillover0_nsk0_xgr1_knspil1_sep1_countec0_GovRev0_etaa0.79_lgd0.png}
	\end{minipage}	
	\begin{minipage}[]{0.32\textwidth}
		\centering{\footnotesize{(g)growth green}}
		%	\captionsetup{width=.45\linewidth}
		\includegraphics[width=1\textwidth]{../../codding_model/own_basedOnFried/optimalPol_010922_revision/figures/all_13Sept22/CompTaul_Equlab_LFBAU_Reg0_gAg_spillover0_nsk0_xgr1_knspil1_sep1_countec0_GovRev0_etaa0.79_lgd0.png}
	\end{minipage}	
	\begin{minipage}[]{0.32\textwidth}
		\centering{\footnotesize{(g)growth fossil}}
		%	\captionsetup{width=.45\linewidth}
		\includegraphics[width=1\textwidth]{../../codding_model/own_basedOnFried/optimalPol_010922_revision/figures/all_13Sept22/CompTaul_Equlab_LFBAU_Reg0_gAf_spillover0_nsk0_xgr1_knspil1_sep1_countec0_GovRev0_etaa0.79_lgd0.png}
	\end{minipage}	
	%	\begin{minipage}[]{0.32\textwidth}
	%		\centering{\footnotesize{(g)growth aggregate}}
	%		%	\captionsetup{width=.45\linewidth}
...
The average wage rate reduces! In contrast to the effect of heterogeneous labor shares, less labor supply reduces wages. Could be because skills are complements! Reducing either reduces productivity of the other. 
...
\subsection{Comparison to model with equal capital share}
Effect of heterogenous capital shares: Income tax progressivity redcues Green to fossil ratio when capital shares are equal. However, when capital shares are different, a higher tax progressivity leaves the ratio of G to F almost unaffected
