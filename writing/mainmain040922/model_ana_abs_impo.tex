\section{Tractable Model}\label{sec:mod_an}
...
This section develops a general model  to derive the theoretic results. 
...
\end{align}
The scaling parameter $\lambda$ adjusts to balance the government's budget. 
