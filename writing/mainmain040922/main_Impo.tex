	...
	\begin{abstract}
		\begin{singlespacing}
			...
			Some scholars argue for limiting consumption to handle tightening environmental constraints \citep{Schor2005SustainableReductionb, VanVuuren2018AlternativeTechnologies}. Can reductive measures help mitigate environmental externalities?
			 ...
			 When lump-sum rebates are not available, the planner uses progressive labor income taxes to decrease work effort. 
			I quantify the optimal income tax in an endogenous growth model with skill heterogeneity.
			On the one hand, a progressive labor tax diminishes the level of production. On the other hand, it recomposes the economic structure towards fossil production due to a skill bias of the green sector. % and high-skill labor being more responsive to tax progressivity.
