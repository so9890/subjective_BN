...
First, in subsection \ref{subsec:exp}, I discuss how a carbon tax equal to the social costs of carbon calculated by the \textit{Resources for the Future} (RfF), an independent research institution, affects the economy, and I calculate a necessary environmental tax to satisfy the US emission limit with and without progressive income tax. 
