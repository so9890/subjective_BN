...
The optimal income tax scheme is mildly progressive in the first periods and becomes regressive afterwards. The gains of this policy is more fossil growth during initial periods until 2035 and higher growth rates in the green and non-energy sector during the net-zero emission periods. Thanks to the reductive effect of the progressive income tax, the carbon tax is set lower. Once the income tax scheme becomes regressive the optimal carbon tax exceeds the counterpart in the model absent income tax. 

The driving model feature of this result are knowledge spillovers. Absent knowledge spillovers, the optimal income tax scheme is regressive throughout which boosts labor supply in general and raises the high-to-low skill ratio supplied. With knowledge spillovers, the non-energy and energy sector profit from technology levels in the fossil sector. 

The higher tax progressivity in the initial 

\begin{figure}[h!!!]
	\centering
	\caption{Costs and benefits of progressive income taxes }\label{fig:opt_TLs}
	\begin{minipage}[]{0.32\textwidth}
...
\end{minipage}
%\begin{minipage}[]{0.32\textwidth}
%\centering{\footnotesize{\ \\(e) Carbon tax, $\tau_{Ft}$\\ \ }}
%%	\captionsetup{width=.45\linewidth}
...
%		\centering{\footnotesize{(a) Income tax progressivity, $\tau_{\iota t}$ \\ \ }}
%		%	\captionsetup{width=.45\linewidth}
%		\includegraphics[width=1\textwidth]{../../codding_model/own_basedOnFried/optimalPol_010922_revision/figures/all_13Sept22_Tplus30/taul_KN_FullMod_sizeequ0_regime0_spillover0_noskill0_sep0_xgrowth0_PV1_GOV0_etaa0.79_lgd1.png}
%	\end{minipage}
%	\begin{minipage}[]{0.32\textwidth}
%	\centering{\footnotesize{(a) Environmental tax, $\tau_{F t}$ \\ \ }}
%	%	\captionsetup{width=.45\linewidth}
%	\includegraphics[width=1\textwidth]{../../codding_model/own_basedOnFried/optimalPol_010922_revision/figures/all_13Sept22_Tplus30/tauf_KN_FullMod_sizeequ0_regime0_spillover0_noskill0_sep0_xgrowth0_PV1_GOV0_etaa0.79_lgd1.png}
%\end{minipage}
%	\begin{minipage}[]{0.32\textwidth}
%	\centering{\footnotesize{(a)Tls Income tax progressivity, $\tau_{\iota t}$ \\ \ }}
%	%	\captionsetup{width=.45\linewidth}
%	\includegraphics[width=1\textwidth]{../../codding_model/own_basedOnFried/optimalPol_010922_revision/figures/all_13Sept22_Tplus30/taul_KN_FullMod_sizeequ0_regime4_spillover0_noskill0_sep0_xgrowth0_PV1_GOV0_etaa0.79_lgd1.png}
%\end{minipage}
%\begin{minipage}[]{0.32\textwidth}
%	\centering{\footnotesize{(a)Tls Environmental tax, $\tau_{F t}$ \\ \ }}
%	%	\captionsetup{width=.45\linewidth}
%	\includegraphics[width=1\textwidth]{../../codding_model/own_basedOnFried/optimalPol_010922_revision/figures/all_13Sept22_Tplus30/tauf_KN_FullMod_sizeequ0_regime4_spillover0_noskill0_sep0_xgrowth0_PV1_GOV0_etaa0.79_lgd1.png}
%\end{minipage}
%\end{figure}
%Without knowledge spillovers, the optimal income tax is less progressive. Is this due to the progressive income tax being less costly in the non-benchmark model or is it that without knowledge spillovers there is 
...
\begin{figure}[h!!]
	...
	\begin{minipage}[]{0.4\textwidth}
		\centering{\footnotesize{(a) Income tax progressivity, $\tau_{\iota t}$\\ \ }}
		%	\captionsetup{width=.45\linewidth}
		\includegraphics[width=1\textwidth]{../../codding_model/own_basedOnFried/optimalPol_010922_revision/figures/all_13Sept22_Tplus30/CompMod1_OPT_T_NoTaus_taul_regime0_spillover0_knspil0_sep0_extern0_PV1_etaa0.79_lgd1.png}
	\end{minipage}
	\begin{minipage}[]{0.1\textwidth}
		\
	\end{minipage}
	\begin{minipage}[]{0.4\textwidth}
		\centering{\footnotesize{(b) Environmental tax, $\tau_{Ft}$\\ \ }}
		%	\captionsetup{width=.45\linewidth}
		\includegraphics[width=1\textwidth]{../../codding_model/own_basedOnFried/optimalPol_010922_revision/figures/all_13Sept22_Tplus30/CompMod1_OPT_T_NoTaus_tauf_regime0_spillover0_knspil0_sep0_extern0_PV1_etaa0.79_lgd1.png}
	\end{minipage}
\end{figure}
...
\begin{figure}[h!!]
	...
	\begin{minipage}[]{0.4\textwidth}
		\centering{\footnotesize{(a) Income tax progressivity, $\tau_{\iota t}$\\ \ }}
		%	\captionsetup{width=.45\linewidth}
		\includegraphics[width=1\textwidth]{../../codding_model/own_basedOnFried/optimalPol_010922_revision/figures/all_13Sept22_Tplus30/CompMod1_OPT_T_NoTaus_taul_regime4_spillover0_knspil0_sep0_extern0_PV1_etaa0.79_lgd1.png}
	\end{minipage}
	\begin{minipage}[]{0.1\textwidth}
		\
	\end{minipage}
	\begin{minipage}[]{0.4\textwidth}
		\centering{\footnotesize{(b) Environmental tax, $\tau_{Ft}$\\ \ }}
		%	\captionsetup{width=.45\linewidth}
		\includegraphics[width=1\textwidth]{../../codding_model/own_basedOnFried/optimalPol_010922_revision/figures/all_13Sept22_Tplus30/CompMod1_OPT_T_NoTaus_tauf_regime4_spillover0_knspil0_sep0_extern0_PV1_etaa0.79_lgd1.png}
	\end{minipage}
\end{figure}
\begin{comment}
