...
\text{Final Good}\hspace{4mm}& Y_{t}=c_t+\psi\left(\int_{0}^1x_{idt}di+\int_{0}^1x_{ict}di\right)%\psi \left(\int_0^1\left(\alpha\frac{p_{dt}}{\psi}\right)^\frac{1}{1-\alpha}A_{idt}L_{dt}+\int_0^1\left(\alpha\frac{p_{ct}}{\psi}\right)^\frac{1}{1-\alpha}A_{ict}L_{ct}\right)
;\\
& \ 
(\text{Numeraire}\ \  p_t=1)\\
