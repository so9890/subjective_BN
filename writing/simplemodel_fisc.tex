...
This solves the model, since, in equilibrium, $H$ is a function of parameters only in equilibrium. 
...
\end{align*}
When goods are substitutes, $\varepsilon>1$, the price in the dirty sectors reduces labour supply in this sector. When goods are complements, labour supply in the dirty sector increases as the dirty goods price rises...
