...
\end{align*}
Imposing labour market clearing for both skills yields
\begin{align*}
l_{lc}= \frac{(1-\theta_c)(\theta_d-\zeta(1-\theta_d))}{\theta_d(1-\theta_c)-\theta_c(1-\theta_d)}h_l.
\end{align*}
Labour good supply is then given by
\begin{align}
L_c&= \underbrace{\left(\frac{\theta_c}{\zeta(1-\theta_c)}\right)^{\theta_c}\frac{(1-\theta_c)(\theta_d-\zeta(1-\theta_d))}{\theta_d(1-\theta_c)-\theta_c(1-\theta_d)}}_{=:\chi_c}h_l\label{eq:lab_inputc} \\
L_d&= \underbrace{\left(\frac{\theta_d}{\zeta (1-\theta_d)}\right)^{\theta_d}\left[1-\frac{(1-\theta_c)(\theta_d-\zeta(1-\theta_d))}{\theta_d(1-\theta_c)-\theta_c(1-\theta_d)}\right]}_{=:\chi_d}h_l.\label{eq:lab_inputd}
\end{align}
...
\begin{align*}
p_d =p_c\left(\frac{\chi_c}{\chi_d}\frac{A_c}{A_d}\right)^{\frac{1-\alpha}{\alpha+\varepsilon(1-\alpha)}}.
\end{align*}
Together with the definition of the aggregate price level and the choice of $Y$ as numeraire determines sector-specific prices:
\begin{align*}
p_c= \left(1+\left(\frac{\chi_c}{\chi_d}\frac{A_c}{A_d}\right)^{\frac{1-\alpha}{\alpha+\varepsilon(1-\alpha)}}\right)^{-\frac{1}{1-\varepsilon}}.
\end{align*}
