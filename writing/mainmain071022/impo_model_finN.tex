...
& \hspace{5mm} +\sum_{J\in\{F,G,N\}}\left(\int_{0}^{I}\pi_{Jit}di-\zeta_{Jt}\int_{0}^{I}p_{Jixt}x_{Jit}di+w_{st}s_{Jt}\right) = 0\\ %\ \hspace{3mm} \forall \ t\in\{0,T\}, \\
& (3)\ \tau_{Ft}F_{t}=T_{ls}\\
