...
In general, these papers focus on environmental taxation and analyze settings with inelastic labor supply so that there is no role for labor income taxes in stabilizing or reducing production. \cite{Golosov2014OptimalEquilibrium} investigate the optimal carbon tax in a dynamic stochastic general equilibrium model. 
...
directly connects to this case. In my framework, the carbon tax is set to internalize its effect on the direction of research. I highlight the need for an additional policy measure to correct the level of economic activity when research subsidies are lacking. 
...
She finds that emission limits can be met at a lower fossil tax when growth is endogenous. To this discussion I add the adverse effect of knowledge spillovers which make a continuous increase in carbon taxes necessary.
...
Secondly, this paper is not the first to integrate distortionary fiscal policies into the analysis of environmental policies. However, the role of fiscal policies has in general been passive, and the focus rest on the impact of preexisting fiscal distortions on the environmental policy. 
...
With its quantitative part, this paper closely relates to \cite{Barrage2019OptimalPolicy} who examines the role of fiscal distortions emerging from an exogenous revenue constraint on the environmental policy in a quantitative framework. She also optimizes jointly over fiscal and environmental policy instruments, but her focus rests on the deviation of the optimal environmental tax from the social costs of carbon.
\begin{comment}
...
An equity-efficiency trade-off is central to this literature.  The benefits of labor taxes and progressivity arise from redistribution and generating government revenues. 
...
To this literature I add another motive for the use of distortionary fiscal policies: to adjust the level of economic activity as part of the optimal environmental policy. 
