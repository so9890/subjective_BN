...
The negative externality of fossil production makes it efficient to alter the share of fossil labor so that  a marginal reallocation of labor to the fossil sector would raise output.\footnote{\ Note that $U_F<0$ by assumption so that the right-hand side is positive and that $\frac{dG}{ds}<0$. Hence, the marginal product of labor in the fossil sector is higher compared to the green sector.} %Hence,$\frp{Y}{F}\frp{F}{s}>-\frp{Y}{G}\frp{G}{s}$ is efficient. }
...
The government is characterized by a Ramsey planner who seeks to maximize utility of the representative household by use of tax and transfer instruments. The behavior of firms and households constrain the government's optimization problem. 
