...
The reason is, that when the carbon tax is set to implement the efficient share of dirty labor, the wage rate reflects the marginal costs of hours through raising emissions. I show in Appendix \ref{app:incometax0} that the wage rate can be written as:

\begin{align*}
w = \frp{Y}{H}+\frac{U_F}{U_C}\frp{F}{H}.
\end{align*}
Therefore, households internalize the marginal social costs of the externality of hours worked in their labor supply decision. Since $U_F<0$, the wage rate and, thus, labor supply decline. Proposition \ref{prop:1} condenses this result.
