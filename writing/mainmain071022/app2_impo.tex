...
\end{figure}
\clearpage
\subsubsection{Comparison integrated and separate policy regime }
\begin{figure}[h!!!]
	\centering
...
%	\end{subfigure}
	...
	\end{subfigure}
	\floatfoot{Notes: \footnotesize{ Graphs show the percentage deviations of the variable under the integrated policy regime where the planner can choose income tax progressivity and the separate regime without income tax, $\tau_{\iota t}=0$. }}
\end{figure} 
