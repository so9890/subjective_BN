...
\begin{figure}[h!!!]
	...
	\caption{Decomposition effect of combined policy: Deviation of green-to-fossil energy ratio in percent}\label{fig:efftaul_GFF}
		\begin{subfigure}{0.32\textwidth}
			\caption{Combined versus carbon-tax-only policy}
			%	\captionsetup{width=.45\linewidth}
		...
		\end{subfigure}
	\begin{subfigure}{0.32\textwidth}
	\caption{Only optimal carbon tax versus carbon-tax-only policy}
	%	\captionsetup{width=.45\linewidth}
...
\end{subfigure}
\begin{subfigure}{0.32\textwidth}
	\caption{Combined policy versus only optimal carbon tax}
	%	\captionsetup{width=.45\linewidth}
