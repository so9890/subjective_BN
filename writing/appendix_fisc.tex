...
Since scientists better qualified to assess these complexities and risks have provided pathways to meet the climate target of 1.5°, I do not model the interaction of emissions and the climate explicitly. Instead, I draw from this literature to specify emission targets \tr{(Check if these take economics into account, too...should because they are IAMs...)}. These enter as constraints into the objective function of the government. (uncertainties include: regeneration rates of the environment, e.g. carbon sinks, and how emissions translate into temperature.)
\tr{\ar In a nutshall, I take from these reports the emission reduction pathes they suggest. I do have to make assumptions on the possibilities of technological innovations. No carbon cycle needed but less assumptions have to be made.}
