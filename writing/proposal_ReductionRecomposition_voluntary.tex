...
\item[\ar] changes or quantity
\item time spent working (income divided by wage)
\item control for income changes \tr{these can be a choice, only account for exogenous changes in income! \ar could use narrative on reason for changes in income, job change... }, family changes, politics, time FE
