...
\item in working time dataset: variables \textit{cw21n526-cw21n510}; For what reasons worked less than 36 hours? \ar e.g. I voluntarily work below 36 hours for leisure...
...
\end{itemize}
\textbf{The policy intervention as in \cite{Pullinger2014WorkingDesign}} \ar Pullinger argues that policies have not been taken up well
...
\begin{figure}[h!!]
	\centering	
	\caption{Share of panelists whcih don't find it necessary to buy new furniture/ clothes}\label{fig:evolution_notNecessary}	
...
\begin{figure}[h!!]
	\centering	
	\caption{\tr{Share of panelists which don't find it necessary to buy new furniture/ clothes: by buys second hand regularly lifestyle}}\label{fig:evolution_notNecessary_bygroup:2ndHand}	
	\begin{minipage}[h!!]{0.32\textwidth}  
		%	\captionsetup{width=.45\linewidth}
		\centering\footnotesize{(a) Replacing new furniture not necessary}
