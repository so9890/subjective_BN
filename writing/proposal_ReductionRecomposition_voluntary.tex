...
\item control for income changes \tr{these can be a choice, only account for exogenous changes in income!, that is, those unrelated with }, family changes, politics, time FE
