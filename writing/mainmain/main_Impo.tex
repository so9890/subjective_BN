...
%	\includepdf[pages=-]{../titlepage.pdf}
	...
	\begin{abstract}
		\begin{singlespacing}
			\textbf{Abstract \ }
			Some scholars argue for limiting consumption to handle tightening environmental constraints \citep{Schor2005SustainableReduction, VanVuuren2018AlternativeTechnologies}. Can reductive measures help mitigate environmental externalities?
			...
			I quantify the optimal income tax in an endogenous growth model with skill heterogeneity, which is progressive. Next to the benefits from more leisure, the income tax is used to substitute for environmental taxes so that the economy can profit from knowledge spillovers from the  non-energy sector. %
