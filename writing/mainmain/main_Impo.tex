...
%	\includepdf[pages=-]{../titlepage.pdf}
	...
	\begin{abstract}
		\begin{singlespacing}
			...
			the efficient allocation consists of both a recomposing and a reductive element. As a result, when no lump-sum transfers are available, distortionary income taxes complement the Pigouvian tax to implement the efficient allocation.
			The finding has important consequences for, first, the discussion of the optimal usage of carbon tax revenues. Second, I the optimal environmental policy increases equity either through lump-sum transfers or income taxation. Third, the result complements the \textit{weak} double-dividend hypothesis: there exists a lower bound on distortionary income taxes after which a further reduction decreases efficiency.
