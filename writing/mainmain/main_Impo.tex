...
%	\includepdf[pages=-]{../titlepage.pdf}
	...
	\begin{abstract}
		\begin{singlespacing}
			...
			I quantify the optimal income tax in an endogenous growth model with skill heterogeneity. The optimal income tax is progressive. Next to the benefits from more leisure, the labor income tax is used to substitute for fossil taxes in the periods before the net-zero emission limit. When the fossil sector is the technologically most advanced,  cross-sector spillovers render fossil taxes costly, substituting fossil taxes with income taxes allows to reap the benefits of spillovers at lower research and work efforts. These benefits come at a higher share of fossil to green energy usage due to a skill bias in the green sector.
