...
\usepackage{ulem}
\title{The Importance of Income Taxes in Meeting Climate Targets}
...
%	\includepdf[pages=-]{../titlepage.pdf}
	...
	\begin{abstract}
		\begin{singlespacing}
			...
			Progressive income taxes reduce labour efforts as leisure becomes relatively cheaper than consumption. The overall reduction in production lowers emissions. On the other hand, tax progressivity recomposes the structure of the economy away from green energy production through a skill supply channel calling for a more regressive tax. For a reasonable calibration, I find that the reduction effect dominates and the optimal income tax schedule is progressive. The model suggests that including progressive income taxes as a tool to lower emissions accounts for a rise in social welfare by 0.13\% over the 60 years from 2020 to 2080. \textbf{Income tax progressivity has a utility advantage above carbon taxes!} % as relative supply of the through a skill-supply channel. As richer, high-skilled workers reduce their labour supply more in response to a more progressive tax, low-skill labour becomes more abundant. 
