...
\usepackage{ulem}
\title{The Importance of Fiscal Policies in the Optimal Environmental Policy}
	...
	\begin{abstract}
		\begin{singlespacing}
			...
			the optimal policy consists of both a recomposing and a reductive element: an environmental tax does not suffice to implement the efficient allocation. Lump-sum transfers complement environmental taxes by reducing labor supply through an income effect.
			 When lump-sum transfers are not available, the optimal income tax is progressive.
			...
			I quantify the optimal income tax in an endogenous growth model with skill heterogeneity. The optimal income tax is progressive even though this reduces growth and increases the share of fossil to green energy production due to a skill bias in the green sector.
