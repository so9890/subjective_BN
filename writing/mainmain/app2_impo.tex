...
\begin{figure}[h!!]
	\centering
	\caption{Effect of optimal environmental tax }\label{fig:LF_vs_onlytauf}
	\begin{minipage}[]{0.32\textwidth}
		\centering{\footnotesize{(a)  Green-to-fossil energy ratio}}
		%	\captionsetup{width=.45\linewidth}
...
\begin{figure}[h!!]
	\centering
	\caption{Comparison optimal allocation and laissez-faire without knowledge spillovers }\label{fig:noKNSPIL}
		\begin{minipage}[]{0.32\textwidth}
