...
\subsubsection{With an environmental tax, the wage rate in the competitive equilibrium is below the marginal product of labor}
...
\subsection{Derivation $\tau_f^*$ without lump-sum transfers, propositions \ref{prop:2}}
	
Solving the Ramsey planner's first order condition with respect to $s$, yields

\subsubsection{Derivation $\tau_l$, proposition \ref{prop:2}}\label{app:subsub_nltaul}
