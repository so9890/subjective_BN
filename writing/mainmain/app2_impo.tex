...
\subsection{Regime with lump-sum transfers and with exogenous growth}

\begin{figure}[h!!]
	\centering
	\caption{Comparison lump-sum transfers with and without policy}\label{fig:lumpsum_xgr_vglNotaul}
...
\subsection{Regime with lump-sum transfers without skill heterogeneity}
\begin{figure}[h!!]
	\centering
	\caption{Comparison lump-sum transfers with and without policy}\label{fig:lumpsum_noskill_vglNotaul}
