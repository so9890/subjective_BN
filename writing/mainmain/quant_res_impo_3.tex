...
\end{figure}
 ...
 \begin{figure}[h!!]
 	\centering
 	\caption{Effect of income tax due to endogenous growth \tr{there seems to be something wrong with GFF in xgr model?} }\label{fig:count_taul_xgr}
 	\begin{minipage}[]{0.32\textwidth}
 		\centering{\footnotesize{(a) Consumption\\ \ }}
 		%	\captionsetup{width=.45\linewidth}
 	...
 	\end{minipage}
 	\begin{minipage}[]{0.32\textwidth}
 		\centering{\footnotesize{(g) Green-to-fossil labour\\ \ }}
 		%	\captionsetup{width=.45\linewidth}
 	...
 	\end{minipage}
 	\begin{minipage}[]{0.32\textwidth}
 		\centering{\footnotesize{(k) sgsff\\ \ }}
 		%	\captionsetup{width=.45\linewidth}
