...
\end{figure}
  ...
  \begin{figure}[h!!]
 	\centering
 	\caption{Deviation from efficient allocation by model }\label{fig:comp_mod_allo}
 	\begin{minipage}[]{0.32\textwidth}
 		\centering{\footnotesize{(a) Consumption}}
 		%	\captionsetup{width=.45\linewidth}
