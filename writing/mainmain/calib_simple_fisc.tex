...
In the second step, I calibrate the weight on energy in final good production by matching the average expenditure share on energy relative to GDP over the period from 2015 to 2019 taken from the U.S. Energy Information Administration (EIA). The expenditure share equals 6\%.\footnote{\ The data on energy was retrieved from \url{https://www.eia.gov/totalenergy/data/monthly/}
 ...
 % procedure
 The most recent IPCC report \citep{IPCC2022} formulates a reduction of global CO2 emissions in the 2030s by 50\% relative to 2019\footnote{\ p. 5 Chapter 3: "\textit{Mitigation pathways limiting warming to 1.5°C [...] reach 50\% reductions of CO2 in the 2030s, relative to 2019, then reduce emissions further to reach net zero CO2 emissions in the 2050s [...] (\textnormal{medium confidence}).}"}  as essential to meeting 1.5°C climate targets.  Furthermore, the report foresees a global net-CO2 budget from 2020 to the net-zero phase  of 510 GtCO2. 
...
% sinks
 ...
 Data on population comes from \url{https://data.oecd.org/pop/population.htm}. 
 ...
 I use the UN projected population measure to proxy for future population size.\footnote{\ Retrieved on 4 August, 2022 from \url{https://population.un.org/dataportal/data/indicators/49/locations/900,840/start/2010/end/2100/table/pivotbylocation}.} 
 I abstract from other greenhouse gases as the main driver of climate warming \textit{WG3 IPCC report p.37 \textbf{\textit{The trajectory of future CO2 emissions plays a critical role in mitigation, given CO2 long-term impact
			32 and dominance in total greenhouse gas forcing}}. Furthermore, \textbf{The main reason is that scenarios reduce non-CO2
		54 greenhouse gas emissions less than CO2 due to a limited mitigation potential (see 3.3.2.2)} p.34 in foxit, 3-26 in chapter 3}. The calibration is done with respect to CO2 emissions. 


Using the population share of the US to determine the emission limit results in a remaining net CO2 budget for the period 2020-2035 below the period of 2035-2050. This conflicts with the downward sloping time path of emissions foreseen by the IPCC (p.3-28).\footnote{\ The reason is that global net-CO2 emissions are so high, that a 50\% reduction starting from 2035 results in more than half the emissions of the remaining carbon budget. }
To generate a downward sloping pattern, I require the remaining budget per annum for the 2020-2035 period to exceed the budget used for the later period. 
Hence, the smallest adjustment follows from equal budgets per period. 
I reduce each limit in the 2035-2050 period so that in sum total emissions equal 510*population share US/2.

This result leads to the following emission limits
From 2020 to 2035 there is a total budget of net-CO2 emissions of 10.627Gt for the US. From 2035 to 2050 model-period emissions may amount to [2.900, 2.854, 2.809].\footnote{\ I use here that in earlier test runs the emission limits have been fully exploited. }
