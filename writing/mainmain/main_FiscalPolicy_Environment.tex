...
%	\includepdf[pages=-]{../titlepage.pdf}
	...
	\begin{abstract}
		\begin{singlespacing}
			\textbf{Abstract \ }
Fiscal policy instruments have gained little attention as an environmental policy instrument. But, the tight time frame and political opposition against carbon taxes motivate to study fiscal policies as a means to tackle environmental externalities. By use of a tractable model I show that the optimal income tax progressivity is highly progressive. 
