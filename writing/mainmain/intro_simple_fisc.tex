...
For the quantitative analysis, I embed a non-linear income tax scheme commonly studied in the public finance literature \citep[e.g.][]{Heathcote2017OptimalFramework} into an endogenous growth model designed to investigate environmental policies.  
...
Furthermore, endogenous growth amplifies repercussions of progressive income taxes. 
...
\paragraph{role of income tax progressivity}
\ar reduces emissions but increases fossil-input supply

\paragraph{Lit: environmental policy}In contrast to the literature, the inefficiency of environmental taxes arises absent inequality or the need to generate government funds in a distortionary fiscal setting. In other words, the way how environmental tax revenues are redistributed determines whether the government has to take additional measures to correct for inefficient hours worked.
