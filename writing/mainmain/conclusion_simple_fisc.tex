...
%In the quantitative setting, the income tax affects the economic structure through a skill-recomposition channel. As high-skill labor reduces more in response to a higher income tax progressivity, a skill bias in the green sector makes green energy production more costly compared to fossil production. %This effect arises from a skill bias in the green sector and high-skill labor being more responsive to income taxation. 
%The second channel dominates the recomposing effect of  income tax progressivity in equilibrium.
% A market size effect amplifies the skill-recomposition channel directing research to the fossil sector. 
