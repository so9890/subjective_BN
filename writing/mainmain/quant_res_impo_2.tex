...
\begin{minipage}[]{0.32\textwidth}
	\centering{\footnotesize{(c) Skill homogeneity}}
	%	\captionsetup{width=.45\linewidth}
	\includegraphics[width=1\textwidth]{../../codding_model/own_basedOnFried/optimalPol_190722_tidiedUp/figures/all_July22/GovCon_SingleAltPolOPT_T_NoTaus_regime3_spillover0_noskill1_sep1_xgrowth1_etaa0.79.png}
\end{minipage}
\begin{minipage}[]{0.32\textwidth}
	\centering{\footnotesize{(c) Skill homogeneity}}
	%	\captionsetup{width=.45\linewidth}
	\includegraphics[width=1\textwidth]{../../codding_model/own_basedOnFried/optimalPol_190722_tidiedUp/figures/all_July22/C_SingleAltPolOPT_T_NoTaus_regime3_spillover0_noskill1_sep1_xgrowth1_etaa0.79.png}
\end{minipage}
\end{figure} 
