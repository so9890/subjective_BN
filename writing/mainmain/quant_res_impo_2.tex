...
How does the optimal allocation and especially its relation to the efficient allocation change once alternaive policy set-ups are chosen?
In this section, I discuss two alternative policy scenarios which have already been discussed in the analyitical section: first, a version where environmental tax revenues are consumed by the government and no labor income tax scheme is available. The comparison of this scenario serves to assess the benefits of an integrated environmental-fiscal policy when no lump-sum transfers are available. 

In the second alternation, I look at the optimal allocation when lump-sum transfers are available. According to the theory, the availability of lump-sum taxes should (i) deprive the income tax scheme of its use for the environmental policy, and (ii) should result in an allocation closer to the efficient allocation than the benchmark scenario, i.e. the integrated policy. 
