...
\begin{prop}[Effect of $\tau_l$ on dirty output]
	In the representative agent model \tr{with log utility}, tax progressivity does not affect the equilibrium ratio of sector production. Fiscal policy can only lower dirty output by reducing aggregate labour supply.
\end{prop}

\subsection{Model with Inequality and MaCurdy preferences}
