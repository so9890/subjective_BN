...
To allow the planner to reduce growth, I endogenize the supply of scientists which are essential for innovation contrary to the literature \citep{Acemoglu2012TheChange, Fried2018ClimateAnalysis}. %Scientists are part of the representative household
...
The model suggests the use of labor income taxes as substitutes for environmental taxes. Meeting emission limits by bluntly reducing overall production through labor income taxes allows to profit from knowledge spillovers. 
Yet, exploitation of this mechanism is limited in size and scope. Once the net-zero emission limit binds, corrective taxes can only be reduced slightly when the income tax is progressive, and aggregate growth reduces relative to a scenario without income tax. %Overall, the results suggest a rather clear cut between responsibilities of policy instruments, since the environmental tax remains largely unchanged irrespective of whether an income tax is used. 
