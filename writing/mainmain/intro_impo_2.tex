...
In the first part of the paper, I show with a simple model that once 
...
%\textcolor{blue}{This is interesting independent of whether they are feasible or not. Could relate to the fact that there is a discussion how to use revenues. Yet, one might argue that we are always in a setting with distortionary labor income taxes; so that recycling lump-sum is never needed; numbers on size of expected revenues and government spending}
 When environmental tax revenues are not redistributed lump-sum, then  environmental taxes are optimally complemented with progressive labor income taxes. Environmental and labor income taxes are complements: the motive for labor taxation does not stem from the environmental externality as such; it follows indirectly from a distortion in labor markets induced by the environmental policy. % to lower inefficiently high hours worked. 
...
In the second part, I scrutinize whether progressive income taxes remain optimal in a more realistic quantitative model with endogenous growth and heterogeneous skills when environmental tax revenues are not redistributed. 
...
These results speak to a politically and academically discussed question: how best to use environmental tax revenues. By pointing to the inefficiency arising from non lump-sum redistributing environmental tax revenues, this paper stresses one aspect which seemed to have been overlooked in the debate. If environmental tax revenues are not redistributed lump-sum, then progressive labor income taxes help to lower inefficiently high hours worked. 
The results address the so-called \textit{weak double-dividend} which posits that recycling environmental tax revenues to reduce pre-existing tax distortions is advantageous to recycling as lump-sum transfers in order not to reduce labor supply further. The findings in the present paper point to a lower bound: when environmental tax revenues are not redistributed lump-sum, some reduction in labor supply via distortionary income taxes is in fact efficient. %\tr{Think about that labor income tax revenues are redistributed back to households but they would not under the weak double dividend hypossis} 
...
The Ramsey planner maximizes social welfare as in the core model. However, the externality enters as an exogenous emission limit which constraints government action. The planner sets the environmental tax and the progressivity parameter of the non-linear income tax scheme. Environmental tax revenues are consumed by the government. As discussed in the analytical section, under this policy regime the efficient allocation is not feasible; but, it is more policy relevant. 
