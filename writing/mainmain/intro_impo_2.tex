...
To shed light on the role of endogenous growth and skill heterogeneity on the optimal policy, I run the analysis in modified models simplifying separately on either dimension. 
