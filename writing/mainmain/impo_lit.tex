...
\tr{\cite{LansBovenberg1994EnvironmentalTaxation}: they compare two cases 1) no gov spending requiremen, and lump-sum transfers; 2) gov spending requirement/ no lump sum transfers; What is missing and interesting: no gov spend requirements and no lump-sum transfers: BUT they only verbally comment on the weak double dividend}
