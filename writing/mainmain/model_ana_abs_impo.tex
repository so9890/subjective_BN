...
\subsubsection{Without lump-sum transfers  optimal environmental policy}
...
If government revenues increase with the share of dirty labor, then does the optimal environmental tax exceed the social cost of pollution. 

Following similar steps than in the previous section yields 
\begin{align}
