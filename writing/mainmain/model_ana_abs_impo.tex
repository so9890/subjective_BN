...
% 
 ...
 xxx
 Why is $\tau_\iota$ progressive? \tr{This should become clear after showing that absent $\tau_\iota$ and lump-sum transfers, hours are too high, ect.!}
...
\begin{proof}\textit{The optimal allocation is efficient}
	First, since $Gov=0$ when environmental tax revenues are redistributed through the income tax scheme, the Ramsey planner's first order condition with respect to the dirty labor share ensures that the optimal environmental tax equals the social cost of pollution; compare equation \ref{eq:pigou}. 

	Show that hours are efficient.
\end{proof}
