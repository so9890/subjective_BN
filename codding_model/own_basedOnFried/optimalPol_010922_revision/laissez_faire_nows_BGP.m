function f=laissez_faire_nows_BGP(x, params, list, pol, laggs, indic, input_lab)
% Model
...
sff = input_lab(list.const=='sff');
sg = input_lab(list.const=='sg');
sn = input_lab(list.const=='sn');
S = input_lab(list.const=='S');
hhf = input_lab(list.const=='hhf');
hlf = input_lab(list.const=='hlf');
hhn = input_lab(list.const=='hhn');
hln = input_lab(list.const=='hln');
hhg = input_lab(list.const=='hhg');
hlg = input_lab(list.const=='hlg');
hh  = input_lab(list.const=='hh');
hl = input_lab(list.const=='hl');
