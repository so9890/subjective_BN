...
function answ =bgp_new(pf0, pg0, wh0, wl0, a0, alphaf, alphag,alphan, deltaef, deltaeg, deltaff, deltafo,deltaye, deltayn,...
...
d4 = hlhh- wh0*zh*(1/(LMHHg*helpg*(thetag/(1-thetag)*wl0/wh0)^thetag)+ 1/(LMHHn*helpn*(thetan/(1-thetan)*wl0/wh0)^thetan) ...
