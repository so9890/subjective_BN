function  [ceq]= calibRem_nows_fsolve_GOOD_nonsep(x, MOM, list, trProd, paramss, poll, Af, An, Ag)
...
q=q+1;
ceq(q)= MOM.targethour-(ws/(chiis)).^(1/sigmaas);  % equal disutility as for other labour => pins down ws
%  q=q+1;
