...
if indic.target==0
    ...
    if ~isfile(sprintf('SP_notarget_0308_spillover%d_noskill%d_sep%d_extern0_xgrowth%d_PV%d_etaa%.2f.mat', indic.spillovers, indic.noskill, indic.sep,indic.xgrowth, indic.PV, params(list.params=='etaa')))
        if indic.noskill==0
