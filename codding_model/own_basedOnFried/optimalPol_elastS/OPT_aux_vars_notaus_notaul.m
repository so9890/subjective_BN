function [hhf, hhg, hhn, hlg, hlf, hln, xn,xf,xg,Ag, An, Af,...
            ...
            wln, wlg, wlf, SWF, S]= OPT_aux_vars_notaus_notaul(x, list, params, T, init201519, indic)

        % version of ramsey planner problem without taul! 
        % => comparison to full model gives effect (contribution) of taul! 
