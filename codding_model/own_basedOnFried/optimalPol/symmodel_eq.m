...
function [indexx, model, model_param_trans, varsModel, paramsModel]=symmodel_eq(Obj, symmsoptim, symmsparams, params, symmssolve, file_name, x_init, x, non_pol_num, non_pol_sym, list, taul_sym)
