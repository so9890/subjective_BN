function [deltaa, omegaa, E_vec]= calibration_emissions(T, lengthh, outputFossil)
...
omegaa   = emissionsUS2019/outputFossil; % share of dirty output which translates into emissions 
