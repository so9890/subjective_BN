...
\item quantitative
\begin{enumerate}
	\item progressivity of income tax even though reduces growth and green-to-fossil ratio (but reduces tauf slightly as opposed to separate policy regime)
	\item welfare gain of 7.45\%; integrated policy close to welfare with lump-sum transfers
	\item lump-sum transfers reduce hours closer to efficient level; usage of regressive income taxes to boost growth; separate policy regime optimal
	\item endogenous growth makes environmental tax costly, planner forfeits growth to meet emission limits
	\item what about lump-sum transfers to the poor only?
\end{enumerate}
\end{itemize}
